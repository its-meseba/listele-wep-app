  ...
  return (
    <section className="py-20 sm:py-28 bg-gray-50 dark:bg-slate-800">
      <div className="container mx-auto px-6 text-center">
        ...
        >
          Why build if no one is waiting? Announce your idea today, see if the market is ready, and move forward without wasting time.
        </motion.p>
        <motion.div
        ...
        >
          <div className="p-8 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 hover:shadow-lg hover:border-[#D8FF00] dark:hover:border-[#D8FF00] transition-all duration-300">
            <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">Prove Demand, Not Assumptions</h3>
          ...
          <div className="p-8 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 hover:shadow-lg hover:border-[#D8FF00] dark:hover:border-[#D8FF00] transition-all duration-300">
            ...
            <p className="text-gray-900 dark:text-gray-300">
              These aren't just emails; they're your first supporters who believe in your vision. Talk to them, learn, and build your product together.
            </p>
          </div>
          <div className="p-8 border border-gray-200 dark:border-slate-700 rounded-lg bg-white dark:bg-slate-900 hover:shadow-lg hover:border-[#D8FF00] dark:hover:border-[#D8FF00] transition-all duration-300">
            <h3 className="text-2xl font-bold mb-4 text-black dark:text-white">Stay Motivated</h3>
            <p className="text-gray-900 dark:text-gray-300">
              Every new person on your list is a reason to start building. Don't delay when you have an audience waiting—start building.
            </p>
          </div>
        </motion.div>
      </div>
