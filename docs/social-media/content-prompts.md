# first100.lumiostudio.co - Social Media Content Prompts
...
*   **Final Scene:** End with the first100.lumiostudio.co logo and the tagline: **"Fikrini Listelee, İşini Test Et."**
...
**Goal:** To teach founders a core startup principle (validation before building) in a simple, memorable way and associate that principle directly with first100.lumiostudio.co. This is a "how-to" video disguised as a strong opinion.
...
*   **Final Scene:** End with the first100.lumiostudio.co logo and the text: **"Önce Doğrula, Sonra Geliştir."** (First Validate, Then Build.)
...
> Artık değil.
>
> first100.lumiostudio.co'nun yeni "Kurucu Modu" ile tanışın.
>
> İzle.
>
...
1.  **Start with the AI Prompt:** Record your screen. Open the first100.lumiostudio.co "Founder Mode" interface.
...
6.  **Final CTA:** The screen fades to the first100.lumiostudio.co logo with the text: **"Sen Fikrini Söyle, Gerisini Bize Bırak."** (You state the idea, leave the rest of us.)
...
**Goal:** To celebrate the users of first100.lumiostudio.co, creating powerful social proof and fostering a sense of community. It shows that the platform is not just a tool, but a platform for real people with real ideas.
...
> Bunlar başlangıç.
>
> first100.lumiostudio.co bir araç olabilir, ama bu topluluğun kahramanı sizlersiniz.
>
...
1.  **Opening:** Start with a shot of the first100.lumiostudio.co dashboard, showing a list of different project names. (e.g., "Sürdürülebilir Kahve," "AI Ders Asistanı," "El Yapımı Takı Atölyesi").
2.  **Montage of Pages:** Create a dynamic, fast-cut sequence showcasing different-looking landing pages built with first100.lumiostudio.co.
...
3.  **Map Animation:** As the voiceover mentions Istanbul, Ankara, and Izmir, show a simple animated map of Turkey with pins dropping on those cities, connecting them to a central first100.lumiostudio.co logo.
...
6.  **Final CTA:** End with the first100.lumiostudio.co logo and the text: **"Türkiye'nin Kurucuları Burada."** (Turkey's Founders are Here.)
